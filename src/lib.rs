// src/lib.rs
/*
 * Core library for ChainInterface
 */
...
#[derive(Debug)]
pub struct ChainInterfaceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainInterfaceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainInterface processing");
    
    let mut processor = ChainInterfaceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainInterfaceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainInterfaceProcessor::new(false);
